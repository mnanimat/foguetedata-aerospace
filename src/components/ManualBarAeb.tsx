...
export const ManualBarAeb: React.FC<ManualBarAebProps> = ({ currentUser, onOpenAuthModal }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-black border border-blue-500/30 rounded-lg p-4 lg:p-5 shadow-lg dark:shadow-2xl relative overflow-hidden">
        <div className="max-w-3xl space-y-3 relative z-10">
          <div className="inline-flex items-center gap-1.5 bg-blue-100 dark:bg-blue-500/10 border border-blue-500/30 text-blue-800 dark:text-blue-300 text-[10px] px-2.5 py-0.5 rounded font-mono">
          ...
          <div className="flex flex-wrap gap-2 text-[10px] font-mono">
            <span className="bg-blue-100 dark:bg-blue-950/80 border border-blue-300 dark:border-blue-600/50 text-blue-800 dark:text-blue-300 px-2.5 py-1 rounded-md">
              🏛️ <strong>BAR:</strong> Associação Brasileira de Minifoguetes
            </span>
            <span className="bg-purple-100 dark:bg-purple-950/80 border border-purple-300 dark:border-purple-600/50 text-purple-800 dark:text-purple-300 px-2.5 py-1 rounded-md">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700 font-mono text-xs px-3 py-1.5 rounded transition"
            >
      ...
      <div className="bg-white dark:bg-black border-2 border-blue-500/40 rounded-lg p-4 lg:p-5 shadow-lg dark:shadow-2xl space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-3">
          <div>
            <div className="inline-flex items-center gap-1 bg-amber-100 dark:bg-amber-500/10 text-amber-800 dark:text-amber-300 border border-amber-500/30 px-2 py-0.5 rounded text-[10px] font-mono font-bold mb-1">
              <UserCheck className="w-3 h-3 text-amber-400" />
              Espaço de Contribuição Especial
            </div>
          ...
          <div className="text-right font-mono text-[11px] text-slate-600 dark:text-slate-400">
            ...
            <span className="text-blue-600 dark:text-blue-400 font-bold block">Micael Nildo</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmitContribution} className="space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1 font-mono text-[11px]">Nome do Autor</label>
              <input
                type="text"
                required
                ...
                className="w-full bg-slate-50 dark:bg-[#05070A] border border-slate-300 dark:border-slate-800 rounded p-2 text-slate-900 dark:text-white focus:border-blue-500 outline-none font-mono"
              />
            </div>

            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1 font-mono text-[11px]">E-mail de Contato</label>
              <input
                type="email"
                required
                placeholder="Digite sua resposta..."
            ...
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1 font-mono text-[11px]">Instituição / Equipe</label>
              <input
                type="text"
                placeholder="Digite sua resposta..."
          ...
          <div className="text-xs">
            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1 font-mono text-[11px]">Tópico do Manual a Contribuir</label>
            <select
              value={topicTitle}
            ...
            {topicTitle === 'custom' && (
              <div className="mt-2 text-xs">
                <label className="block text-amber-700 dark:text-amber-400 font-semibold mb-1 font-mono text-[11px]">
                ...
                <input
                  ...
                  className="w-full bg-orange-50 dark:bg-[#05070A] border border-amber-300 dark:border-amber-500/60 rounded p-2 text-slate-900 dark:text-white focus:border-amber-500 dark:focus:border-amber-400 outline-none font-mono text-xs shadow-inner"
                />
              </div>
            )}
          </div>
          ...
          <div className="text-xs">
            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1 font-mono text-[11px]">
            ...
            <textarea
              ...
              className="w-full bg-slate-50 dark:bg-[#05070A] border border-slate-300 dark:border-slate-800 rounded p-2.5 text-slate-900 dark:text-white focus:border-blue-500 outline-none leading-relaxed font-mono text-[11px]"
            />
          </div>
          ...
          {submittedMessage && (
            <div className="p-3 bg-emerald-50 dark:bg-emerald-950/80 border border-emerald-300 dark:border-emerald-500/50 rounded-xl text-emerald-800 dark:text-emerald-300 text-xs flex items-center gap-2">
        ...
        <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800">
          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-200 uppercase font-mono">Contribuições Registradas na Plataforma</h3>

          <div className="space-y-3">
            {contributions.map((c) => (
              <div
                key={c.id}
                className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-4 space-y-2 relative shadow-sm dark:shadow-none"
              >
                <div className="flex justify-between items-start gap-2">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {c.isSpecialAuthor && (
                        <span className="bg-amber-100 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-500/40 text-[10px] font-mono px-2 py-0.5 rounded-full font-semibold">
                          Autor(a)
                        </span>
                      )}
                    </div>
                  ...
                  <span className="text-[11px] font-mono text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950 px-2 py-1 rounded border border-blue-200 dark:border-blue-800">
                    {c.topicTitle}
                  </span>
                </div>

                <p className="text-xs text-slate-700 dark:text-slate-300 leading-relaxed italic bg-slate-50 dark:bg-slate-900/60 p-3 rounded-lg border border-slate-200 dark:border-slate-800">
                  "{c.proposedContent}"
                </p>

                <div className="text-[10px] text-slate-500 font-mono flex justify-between pt-1">
                  <span>Data de Submissão: {c.date}</span>
                  <span className="text-emerald-700 dark:text-emerald-400 font-semibold">Status: Integrado no Rascunho BAR-AEB</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 lg:p-8 shadow-md dark:shadow-xl space-y-6">
        <div>
          <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400 font-mono text-xs uppercase tracking-wider mb-1">
            <Calendar className="w-4 h-4" />
            Cronograma do Manual BAR-AEB
          </div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Plano de Ação Inicial - Etapas e Prazos</h2>
            ...
            <div
              ...
              className={`p-4 rounded-xl border flex flex-col justify-between space-y-2 ${
                step.status === 'concluido'
                  ? 'bg-emerald-50 dark:bg-emerald-950/20 border-emerald-300 dark:border-emerald-500/30 text-emerald-900 dark:text-slate-200'
                  : step.status === 'em_andamento'
                  ? 'bg-blue-50 dark:bg-blue-950/30 border-blue-300 dark:border-blue-500/40 text-blue-900 dark:text-white'
                  : 'bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400'
              }`}
            >
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xs font-bold text-blue-700 dark:text-blue-400">{step.date}</span>
                  {step.status === 'concluido' ? (
                    <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                  ) : step.status === 'em_andamento' ? (
                ...
                <p className="text-[11px] text-slate-700 dark:text-slate-300 leading-snug">{step.description}</p>
              </div>

              <div className="text-[10px] font-mono text-slate-600 dark:text-slate-400 pt-2 border-t border-slate-200 dark:border-slate-800/80">
                Responsável: <strong className="text-slate-900 dark:text-slate-200">{step.responsible}</strong>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 lg:p-8 shadow-md dark:shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-700 dark:text-slate-300">
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-4 rounded-xl space-y-2">
            <h3 className="font-bold text-blue-700 dark:text-blue-400 text-sm">Classificação de Foguetes Amadores</h3>
          ...
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-4 rounded-xl space-y-2">
            <h3 className="font-bold text-emerald-700 dark:text-emerald-400 text-sm">Distâncias e Segurança Operacional</h3>
            <ul className="list-disc pl-4 space-y-1 text-slate-700 dark:text-slate-300">
